...
![example image](../frontend/assets/example_2025.svg)
...
Generate heatmaps as SVG, put them into the `frontend/assets` folder and link them into the `frontend/index.html` file. Include JavaScript and all the relevant information for tooltips to provide links to the visualized events.
